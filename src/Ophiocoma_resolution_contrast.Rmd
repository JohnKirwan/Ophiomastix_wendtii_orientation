...
```{r}
res.psych.cond <- conditional_effects(res.psych.fit, spaghetti=T, 
...
```{r}
conditional_effects(res.psych.fit, spaghetti=T, nsamples = 1000, summary=FALSE) %>% 
  plot(points=TRUE, point_args = c(data=props,x=T,y=p), mean=TRUE)
```



```{r}
conditional_effects(res.psych.fit, spaghetti=T, nsamples = 1000,robust=TRUE)
```
